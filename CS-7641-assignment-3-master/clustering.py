...
out = 'C:\MachineLearning\Clustering\DimensionReductionClustering\RP\\'
...
### Post Feature Transformation Data Read
...
#%% Data for 1-3
SSE = defaultdict(dict) #standard square error
ll = defaultdict(dict) #log likelihood
acc = defaultdict(lambda: defaultdict(dict)) #accuracy
adjMI = defaultdict(lambda: defaultdict(dict)) #adjusted mutual information
